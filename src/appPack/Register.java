...
public class Register extends javax.swing.JFrame{
    ...
    private void initComponents() {
        ...
        lbl_registerError = new javax.swing.JLabel();
        ...
        jLabel6.setText("Müşteri Kayıt");
        jPanel1.add(jLabel6);
        jLabel6.setBounds(70, 30, 170, 40);

        lbl_registerError.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        lbl_registerError.setForeground(new java.awt.Color(255, 0, 51));
        jPanel1.add(lbl_registerError);
        lbl_registerError.setBounds(50, 390, 180, 60);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(name.equals("")){
            ...
            DB db = DB.instance();
            db.open();
            int status = db.customerInsert(name, surname, telNumber, address);
            db.close();
            if (status > 0) {
                txt_name.setText("");
                txt_surname.setText("");
                txt_tel.setText("");
                txt_address.setText("");
                lbl_registerError.setText("");
                RefreshCustomer();
                JOptionPane.showMessageDialog(rootPane, "Müşteri Başarıyla Eklendi!");
                System.out.println("Müşteri Basariyla Eklendi");
         ...
         lbl_registerError.setText("<html><p style=\"text-align:center;\">" + errorMessage + "</p></html>");
    ...
    javax.swing.JLabel lbl_registerError;
